...
import { MODULE_ID } from './derivativeRuleModel';

interface DerivativeRuleCompletionProps {
  onRestart: () => void;
}
...
export function DerivativeRuleCompletion({ onRestart }: DerivativeRuleCompletionProps) {
  return (
    <motion.div
