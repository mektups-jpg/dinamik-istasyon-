...
const mastery = [
  { title: 'Polinom Kök', value: '-1, 3', detail: 'Çarpanlar sıfır kapısı açtı' },
  { title: 'Rasyonel Yasak', value: 'x=-1', detail: 'Payda sıfır istasyonu ayrıldı' },
  { title: 'Pozitif Bölge', value: '+ +', detail: 'Dış aralıklar > 0 için boyandı' },
  { title: 'Rasyonel Çözüm', value: '(-1,3]', detail: 'Yasak açık, kök kapalı kaldı' },
];

export function InequalityOrbitCompletion({ onRestart }: InequalityOrbitCompletionProps) {
  return (
    <motion.div
    ...
    >
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_26%_14%,rgba(0,229,255,0.18),transparent_32%),radial-gradient(circle_at_80%_22%,rgba(179,136,255,0.14),transparent_30%),linear-gradient(180deg,rgba(255,255,255,0.055),transparent_45%)]" />
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex min-w-0 items-center gap-4">
            <div className="relative grid h-16 w-16 shrink-0 place-items-center rounded-[24px] border border-[#00E5FF]/28 bg-[#00E5FF]/12 shadow-[0_0_34px_rgba(0,229,255,0.18)]">
              ...
              <Orbit className="h-8 w-8 text-cyan-100" />
            </div>
            <div className="min-w-0">
              <p className="font-mono text-[10px] font-black uppercase tracking-[0.22em] text-[#00E5FF]/70">orbit mastery</p>
              <h2 className="mt-1 text-2xl font-black leading-tight text-white sm:text-4xl">İşaret yörüngesi kilitlendi</h2>
              <p className="mt-2 max-w-2xl text-sm font-bold leading-snug text-white/62 sm:text-base">
                Kök, yasak kapı, pozitif bölge ve rasyonel çözüm koridoru aynı radar masasında okundu.
              </p>
            </div>
          </div>
          ...
          <div className="flex shrink-0 items-center gap-3 rounded-[24px] border border-[#00FF88]/22 bg-[#00FF88]/10 px-4 py-3">
            ...
            <div>
              <p className="font-mono text-2xl font-black leading-none text-emerald-100">+150</p>
