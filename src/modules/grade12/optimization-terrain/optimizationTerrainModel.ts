...
export const toolCopy: Record<OptimizationTool, { label: string; short: string; hint: string; accent: string }> = {
  ...
  extremum: {
    label: 'Tepe/Çukur Kapısı',
    short: '0',
    hint: 'Eğim düzleşen kapıya yaklaşır; tepe veya çukur kararı testte kilitlenir.',
    accent: '#FBBF24',
  },
  'max-volume': {
    label: 'Maks Hacim',
    short: 'V↑',
    hint: 'Kapasite kutusu en yüksek doluma ulaştığında maksimum hacim tepesi kilitlenir.',
    accent: '#00E5FF',
  },
  'min-cost': {
    label: 'Min Maliyet',
...
export const optimizationMissions: OptimizationMission[] = [
  ...
  {
    id: 'extremum-gate',
    title: 'Sıfır eğim kapısını aç',
    prompt: "Araç tepenin en üstünde yataylaşıyor. f'(x)=0 kapısı neyi yakalar?",
    atomId: 'MAT.12.2.6.3',
    mode: 'peak',
    ...
    output: 'Ekstremum',
    badge: 'Tepe',
    mechanism: 'Altın sıfır kapısı tırmanıştan inişe geçen noktayı işaretler.',
    ...
    failure: {
      increasing: 'Tepede sürekli artış yok; araç yükselişten inişe dönüyor.',
      decreasing: 'Tepede yalnız iniş yok; dönüş noktası sıfır eğim kapısıdır.',
      ...
      'min-cost': 'Bu bir maliyet vadisi değil; tepe noktasındaki sıfır eğimi oku.',
    },
  },
  {
    id: 'maximum-volume',
    ...
    output: 'Maksimum V',
    badge: 'Kapasite',
    mechanism: 'Mavi kapasite kutusu tepe noktasında en yüksek dolum seviyesine ulaşıyor.',
    ...
    failure: {
      ...
      'max-volume': 'Maksimum hacim doğru hedef: kapasite kutusu tepe noktasında en dolu hâle gelir.',
  ...
  },
  {
    ...
    failure: {
      ...
      'max-volume': 'Bu kapasite kutusu değil; amaç hacmi büyütmek değil maliyeti azaltmak.',
